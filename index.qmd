...
*Slides will be progressively made available*

::: table-schedule
| Session | Date and Time | Topic | Desccription |
|----------------|----------------|----------------|------------------------|
...
| After the workshop | At your own pace | [Post-workshop exercises](exercises.html) |  |
:::
...
2.  Copy the following code: `install.packages(c( "car", "rmarkdown", "huxtable", "gt", "apaTable", "tidyverse"))`
