...
Teaching Assistant: Bryan Bramaskara, MITB
...
| 1 | 22 Aug 2025 |[**Introduction to R and RStudio**](01-intro.html) | Learn about setting up RStudio, basic data types and structures in R, and importing data files. |
| 2 | 29 Aug 2025 | [**Data wrangling with tidyverse**](02-tidyverse.html) | Learn about manipulating data with tidyverse, including filtering, selecting, mutating, and grouping data. |
| 3 | 5 Sep 2025 | [**Data visualization and Descriptive Statistics**](03-visualization.html) | Learn about creating visualizations with ggplot2 and calculating descriptive statistics like mean, median, etc. |
| 4 | 12 Sep 2025 | [**Basic Inferential Tests**](04-stats.html) | Learn about conducting t-tests, chi-square tests, ANOVA, and interpreting statistical results in R. |
| 5 | 19 Sep 2025 | [**Regression and Presenting Your Result**](05-stats-quarto.html) | Learn about regression and various useful packages to generate your result table. |
...
[Please complete the pre-workshop survey here](https://smusg.asia.qualtrics.com/jfe/form/SV_4TqxP3BrvZkf4t8) to share your goals and current knowledge. Your input will help to tailor the workshop contents and pace.
