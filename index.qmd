...
```{=html}
<a href="https://raw.githubusercontent.com/bellaratmelia/introductory-r-socsci/main/data/chile_voting.csv" type="button" class="btn btn-success">Click here to open the CSV file, and then Ctrl + S / Cmd + S to save it locally</a>
```
