...
subtitle: "Academic Year 25/26 Term 2 (Jan - Feb)"
format: html
---
...
| 1 | 16 Jan 2026 |[**Introduction to R and RStudio**](01-intro.html) | Learn about setting up RStudio, basic data types and structures in R, and importing data files. |
| 2 | 23 Jan 2026 | [**Data wrangling with tidyverse**](02-tidyverse.html) | Learn about manipulating data with tidyverse, including filtering, selecting, mutating, and grouping data. |
| 3 | 30 Jan 2026 | [**Data visualization and Descriptive Statistics**](03-visualization.html) | Learn about creating visualizations with ggplot2 and calculating descriptive statistics like mean, median, etc. |
| 4 | 6 Feb 2026 | [**Basic Inferential Tests**](04-stats.html) | Learn about conducting t-tests, chi-square tests, ANOVA, and interpreting statistical results in R. |
| 5 | 13 Feb 2026 | [**Regression and Presenting Your Result**](05-more-stats.html) | Learn about regression and various useful packages to generate your result table. |
