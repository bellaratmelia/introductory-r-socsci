...
-   To create an object we need to give it an object name followed by the assignment operator \<- , and the value we want to give it.
-   Object name rules:
    -   Can’t start with numbers
    -   Case sensitive
    -   No spaces
    -   Some reserved words (like some function names in R)
    -   Good practices: use nouns for object names, and verbs for function names.
