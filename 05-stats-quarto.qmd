...
## Reporting result: A sample regression table with 2 models

![](images/regression-table.png)
...
huxreg("age" = vote_age, statistics = c(R2 = "r.squared", "logLik", "AIC"))
```
