...
Identify which columns can be converted to categorial data (factor). Convert the appropriate categorical variables (country, religiousity, sex, marital_status, employment) to **Factor**.
