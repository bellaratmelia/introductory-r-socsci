...
The variance will be easier to see when we visualize it as well. As we can see, the variance is roughly the same between these two samples.
...
## Visualise the before and after
