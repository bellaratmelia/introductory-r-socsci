...
-   Calculate the Kendall correlation coefficient between age and statusquo.
...
#| echo: true
#| output: true
cor.test(chile_data$age, chile_data$statusquo, method = "kendall")
...
A **t-test** is a statistical test used to compare the means of two groups/samples of continuous data type and determine if the differences are statistically significant. [More in-depth info here!](https://www.sciencedirect.com/topics/mathematics/students-t-test)
...
Is the average age of voters who intend to vote "Yes" significantly different from the overall mean age of voters?
...
3.  Is the average statusquo score significantly different from 0 (0 is the neutral point on the scale)?
...
#| echo: true
#| output: true
t.test(chile_data$statusquo, mu = 5)
```
